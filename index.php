...
<head>
    ...
    <link rel="stylesheet" href="http://<?= $_SERVER['HTTP_HOST'] ?>/poli naufal/dist/css/welcome_styles.css">
</head>

<body>
    <!-- Responsive navbar-->
    <nav style="background-color: #355E3B;">
    ...
    ?>
        <!-- Header-->
        <header class="py-5" style="background-color: #556B2F;">
            <!-- Ubah Color Banner disini -->
            <div class="container px-5">
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-2">Sistem Temu Janji <br>Pasien - Dokter</h1>
                            <p class="lead text-white-50 mb-4">Bimbingan Karir 2023 Bidang Web Developer</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-5 border-bottom">
            <div class="container px-5 my-5 px-5">
                <div class="text-center mb-5">
                    ...
                    <p class="lead mb-0">Pasien Yang Pernah Berobat</p>
                </div>
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <!-- Testimonial 1-->
                        <div class="card mb-4">
                            <div class="card-body p-4">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-4">
                                        <p class="mb-1">Pelayanan di web ini sangat baik!</p>
                                        <div class="small text-muted">- Kevin, Demak</div>
                                    </div>
                                </div>
                            </div>
                        </div>
